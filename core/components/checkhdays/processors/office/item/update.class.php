 ...
 * Update an Item
 */
class CheckHDaysOfficeItemUpdateProcessor extends modObjectUpdateProcessor {
	...
	public function beforeSet() {
		...
		if (empty($id)) {
			return $this->modx->lexicon('checkhdays_item_err_ns');
		}
...
return 'CheckHDaysOfficeItemUpdateProcessor';
